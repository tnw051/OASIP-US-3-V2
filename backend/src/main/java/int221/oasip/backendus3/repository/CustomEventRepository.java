...
public interface CustomEventRepository {
    List<Event> findPastEvents(Instant startAt, @Nullable Collection<Integer> categoryIds, @Nullable Integer userId);
    ...
    List<Event> findByDateRangeOfOneDay(Instant startAt, @Nullable Collection<Integer> categoryIds, @Nullable Integer excludeEventId);
}
